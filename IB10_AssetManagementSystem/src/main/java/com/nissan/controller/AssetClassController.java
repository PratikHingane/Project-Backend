...
public class AssetClassController {
	...
	@GetMapping("assetclasses/{_assetclassesId}")
	public AssetClass getAllAssetClassWithId(@PathVariable Integer _assetclassesId ){
		return assetClassService.getAllAssetClassListById(_assetclassesId);
	}
